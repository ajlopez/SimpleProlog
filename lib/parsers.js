...
pdef.define('fact', [ 'rule', 'separator:.' ], function (values) { return values[0]; });
pdef.define('fact', [ 'query', 'separator:.' ], function (values) { return values[0]; });
pdef.define('fact', [ 'atom', 'separator:.' ], function (values) { return values[0]; });
...
pdef.define('query', [ 'atom:?-', 'element-list' ], function (values) { return structure(atom(values[0]), values[1]); });
